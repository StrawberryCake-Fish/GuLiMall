...
--
-- Host: 127.0.0.1    Database: mall_sms
-- ------------------------------------------------------
...
--
-- Dumping data for table `sms_sec_kill_promotion`
--

LOCK TABLES `sms_sec_kill_promotion` WRITE;
INSERT INTO `sms_sec_kill_promotion` VALUES (1,'iPhone秒杀活动','2020-05-29 20:00:00','2020-06-01 00:00:00',1,NULL,NULL);
UNLOCK TABLES;
...
--
-- Dumping data for table `sms_sec_kill_session`
--

LOCK TABLES `sms_sec_kill_session` WRITE;
UNLOCK TABLES;
...
--
-- Dumping data for table `sms_sec_kill_sku_notice`
--

LOCK TABLES `sms_sec_kill_sku_notice` WRITE;
UNLOCK TABLES;
...
CREATE TABLE `sms_sec_kill_sku_relation` (
  ...
  `sec_kill_count` decimal(10,0) DEFAULT NULL COMMENT '秒杀总量',
  `sec_kill_limit` decimal(10,0) DEFAULT NULL COMMENT '每人限购数量',
  `sec_kill_sort` int(11) DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='秒杀活动商品关联';

--
-- Dumping data for table `sms_sec_kill_sku_relation`
--

LOCK TABLES `sms_sec_kill_sku_relation` WRITE;
UNLOCK TABLES;
