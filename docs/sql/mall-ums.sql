...
CREATE TABLE `ums_integration_change_history` (
  ...
  `source_type` tinyint(4) DEFAULT NULL COMMENT '来源[0->购物；1->管理员修改;2->活动]',
  PRIMARY KEY (`id`)
...
CREATE TABLE `ums_member_level` (
  ...
  `privilege_free_freight` tinyint(4) DEFAULT NULL COMMENT '是否有免邮特权',
  `privilege_member_price` tinyint(4) DEFAULT NULL COMMENT '是否有会员价格特权',
  `privilege_birthday` tinyint(4) DEFAULT NULL COMMENT '是否有生日特权',
  `note` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
