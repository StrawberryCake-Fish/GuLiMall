...
-- ----------------------------
INSERT INTO `sms_sec_kill_promotion`
VALUES (1, 'iPhone秒杀活动', '2020-05-29 20:00:00', '2020-06-01 00:00:00', 1, NULL, NULL);
...
(
    ...
    `sec_kill_price`       decimal(10, 0) NULL DEFAULT NULL COMMENT '秒杀价格',
    `sec_kill_count`       decimal(10, 0) NULL DEFAULT NULL COMMENT '秒杀总量',
    `sec_kill_limit`       decimal(10, 0) NULL DEFAULT NULL COMMENT '每人限购数量',
    `sec_kill_sort`        int            NULL DEFAULT NULL COMMENT '排序',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
...
VALUES (1, 19, 10000.0000, 500.0000, NULL);
INSERT INTO `sms_sku_full_reduction`
VALUES (2, 20, 10000.0000, 500.0000, NULL);
INSERT INTO `sms_sku_full_reduction`
VALUES (3, 21, 10000.0000, 500.0000, NULL);
INSERT INTO `sms_sku_full_reduction`
VALUES (4, 22, 9000.0000, 200.0000, NULL);
...
VALUES (1, 1, 20.0000, 20.0000, NULL);
INSERT INTO `sms_spu_bounds`
VALUES (2, 2, 0.0000, 0.0000, NULL);
